...
public class ConnectionHandler2 extends Thread {

	private static final Logger LOGGER = LogManager.getLogger(ConnectionHandler2.class);
	private Socket clientSocket;
	private String HOST;
	private int PORT;
	private UUID clientId;

	public ConnectionHandler2(String HOST, int PORT, UUID clientId) {
		super();
		try {
			this.HOST = HOST;
			this.PORT = PORT;
	...
	public synchronized boolean isConnectionAuthorized() throws IOException {
		...
		LOGGER.info("Client2 received " + action);
